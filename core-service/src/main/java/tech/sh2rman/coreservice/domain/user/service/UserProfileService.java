...
public interface UserProfileService {
    ...
    Page<UserProfileEntity> search(String q, UUID meUserId, Pageable pageable);

    UserProfileEntity getMe(UUID meUserId);

    UserProfileEntity updateMe(UUID meUserId, UpdateMyProfileRequest req);
}
